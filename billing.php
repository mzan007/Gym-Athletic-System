...
if (isset($_REQUEST["submit"])) {
    $id = $_REQUEST["id"];
    $mid = $_REQUEST["mid"]; // New field for MID
    $name = $_REQUEST["name"];
    $date = $_REQUEST["date"];
    $amount = $_REQUEST["amount"];

    $ins = "INSERT INTO billing (id, mid, name, date, amount) VALUES ('$id', '$mid', '$name', '$date', '$amount')";
...
<form>
  ...
  <div class="form-group">
  <label for="inputMid">Member ID (MID)</label>
  <input type="text" name="mid" class="form-control" id="inputMid" placeholder="Enter MID">
</div>
